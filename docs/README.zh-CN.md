...
1.0 做什么、不做什么：[roadmap.md](roadmap.md)（英文）。
...
Bug 走 issue 表单，功能先开 discussion。首个版本发布前暂不合并外部 PR。流程见 [CONTRIBUTING.md](../.github/CONTRIBUTING.md)，代码规则见 [AGENTS.md](../AGENTS.md)（均为英文）。
