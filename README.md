...
Under development, not yet released. The `main` branch started from a clean history on 2026-09-08 for the local-first rebuild. Earlier prototypes are kept in this repository under the tag `archive/prototypes-2026-09`.
...
This repository keeps the full history of the project since its first commit on 2025-12-10. Everything before the rebuild lives under the tag `archive/prototypes-2026-09`; `main` tells only the story of 1.0.
